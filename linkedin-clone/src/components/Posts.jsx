...
const Posts = (props) => {
    ...
    const getReactions = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log(AllComments, AllReactions, numberComments, numberLikes)
            } else {
    ...
    return (
        <Card className="mt-2 p-2 posts">
            ...
            <p className="border-bottom mb-2 "> {numberLikes > 0 && <><FontAwesomeIcon icon={faThumbsUp} style={{ color: "5894f5" }} /> {numberLikes}</>}{numberComments > 0 && <> - {numberComments} Comments</>} </p>
            ...
            <Row className="mx-2 reactions d-flex justify-content-around">
                ...
                <Button variant="light" onClick={toggleComments}><FontAwesomeIcon icon={faCommentDots} /><span className="d-sm-none d-lg-inline-block">Comment</span> </Button>
