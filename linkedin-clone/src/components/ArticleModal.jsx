    ...
    render() {
        return <div>
            <Modal show={this.props.show} id="uploadModal" onHide={() => this.props.onHide(this.props.title)}>
                ...
                <Modal.Body>
                    <Row md={3}>
                        {this.state.input.length !== 0 && this.state.input.map((input, key) => <Col key={key}> {this.props.title === "photo" ? <Image src={input} fluid /> :
                    ...
                    <Row className="justify-content-center align-items-center">
                        <label className="upload" for="input">Select {this.props.title} to share
                        <input
                ...
                <Modal.Footer>
                    ...
                    <Col>
                        <Button variant="primary" className="rounded-pill w-100" disabled={this.state.input.length !== 0 ? false : true} onClick={this.handelSave}>
                            Done
            </Button>
                    </Col>
                </Modal.Footer>
